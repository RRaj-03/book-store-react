            ...
            <div className={'bg-gray-300 h-auto sm:h-full fixed w-[100%] sm:w-[40%] lg:w-[30%] top-0 transition-all  left-[-100%] sm:left-[-40%] lg:left-[-30%] my-navBoxShadow' + (HamburgerMenu ? " transform  lg:translate-x-[100%] sm:translate-x-[100%] translate-x-[100%]" : "")}>
                <nav className="md:m-auto flex flex-col items-center text-base justify-center">
                    ...
                    <div className='md:m-auto flex flex-col items-center text-base justify-center mb-10'>
                        ...
                        <Link to={"/content/tech"} className="m-auto text-xl hover:text-gray-900 my-1 mt-3">Tech</Link>
                        <Link to={"/content/sports"} className="m-auto text-xl hover:text-gray-900 my-1">Sports</Link>
                        <Link to={"/content/physics"} className="m-auto text-xl hover:text-gray-900 my-1">Physics</Link>
                        <Link to={"/content/chem"} className="m-auto text-xl hover:text-gray-900 my-1">Chemistry</Link>
                        <Link to={"/content/math"} className="m-auto text-xl hover:text-gray-900 my-1">Math</Link>
                    </div>
                </nav>
            </div>
        </header>
